...
reason; it is never reported as a passing LIVE claim.
...
| 11 | [sparse_user_search](sparse_user_search.py) | passing | not recorded | Mapping values at 0/100 despite selected-empty 50; raw bound 150 |
...
| 13 | [elapsed_task_items](elapsed_task_items.py) | passing | not recorded | Five exact JSON slots, task-scoped 50/3/empty pages and 53 IDs |
