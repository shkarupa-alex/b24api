...
| 17 | [numerator_list](numerator_list.py) | endpoint-limited | not recorded | Fixed offsets 0/50; 53 IDs observed, then fail-closed after the short window without qualified closure |
