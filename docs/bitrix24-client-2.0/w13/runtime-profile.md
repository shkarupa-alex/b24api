...
Runtime candidate: `b7f7a99d20479c7f389f44d428bf538e939a9dbd`
...
- 100 repeated traversals after warm-up retain 23,519 bytes, below the 1 MiB ceiling;
...
|---|---:|---:|---:|---:|---:|---:|
| direct call | 1 | 1 | — | 3.5 ms | 2.4 ms | 57,680 B |
| logical batch 10k, buffer 7 | 10,000 | 1,429 | 7 commands | 2.50 s | 1.89 s | 289,459 B |
| logical batch 100k, buffer 7 | 100,000 | 14,286 | 7 commands | 24.19 s | 18.15 s | 265,052 B |
| counted 19 | 19 | 1 | 19 rows | 14.1 ms | 12.8 ms | 2,056,776 B |
| counted 500 | 500 | 2 | 450 rows | 51.4 ms | 37.4 ms | 2,056,776 B |
| counted dense 10k | 10,000 | 5 | 2,500 rows | 747 ms | 502 ms | 3,766,045 B |
| counted uniform-sparse 10k | 10,000 | 5 | 2,500 rows | 764 ms | 506 ms | 3,779,894 B |
| references, INPUT order | 16 events | 16 | 1 row / 2 active | 36.3 ms | 14.5 ms | 91,254 B |
| 110 repeated traversals | 0 | 110 | — | 75.7 ms | 68.9 ms | 107,541 B |
| oversized response refusal | — | 1 | 64 KiB + chunk | 1.2 ms | 1.2 ms | 118,071 B |
...
|---|---:|---:|---:|---:|---:|
| 19 | 1 → 1 | 0.919 | 1.017 | 0.924 | 1.018 |
| 500 | 2 → 2 | 0.959 | 0.948 | 0.953 | 0.947 |
| dense 10k | 5 → 5 | 0.994 | 0.978 | 0.995 | 0.976 |
| uniform-sparse 10k | 5 → 5 | 1.026 | 1.011 | 1.029 | 1.020 |
| clustered-sparse 10k | 5 → 5 | 1.008 | 0.986 | 1.013 | 0.983 |
