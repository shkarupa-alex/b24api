...
| A7 | Done | `93f5494`, `3bccfe4`, `866a47f`, `c6c7164`, `7dd3562` | `tests/diagnostic_rendering_test.py::test_known_v3_code_is_diagnosable_in_str_repr_and_safe_dict`; the §3.9 matrix in `tests/redaction_property_test.py`; `tests/diagnostic_rendering_test.py::test_long_v3_field_is_aliased_before_its_text_is_bounded`, `::test_short_configured_webhook_token_is_still_an_exact_secret`, `::test_short_request_auth_value_is_hidden_as_a_whole_token`, `::test_a_long_v3_code_is_redacted_before_it_is_cut` |
